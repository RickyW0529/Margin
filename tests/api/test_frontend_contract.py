...
FRONTEND_API_PATHS = {
    ...
    "/strategies/{strategy_id}/versions/{version_id}/backtest",
    "/strategies/{strategy_id}/versions/{version_id}/paper-trade",
    "/strategies/{strategy_id}/versions/{version_id}/prompt",
    "/strategies/{strategy_id}/versions/{version_id}/validate",
}
