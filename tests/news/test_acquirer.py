...
class TestSourceRegistry:
    ...
    def test_register_and_get(self):
        ...
        desc = SourceDescriptor(
            name="sse", source_type="exchange", default_level=SourceLevel.L1
        )
    ...
    def test_list_sources(self):
        ...
        registry.register(SourceDescriptor(
            name="media", source_type="media", default_level=SourceLevel.L4
        ))
    ...
    def test_list_by_type(self):
        ...
        registry.register(SourceDescriptor(
            name="szse", source_type="exchange", default_level=SourceLevel.L1
        ))
        registry.register(SourceDescriptor(
            name="media", source_type="media", default_level=SourceLevel.L4
        ))
...
class TestMockConnector(BaseConnector):
    ...
    Attributes:
        source_name: Fixed source identifier for the mock connector.
    """
    ...
    def fetch(self, url: str, **kwargs):
        ...
        """
        html = (
            "<html><head><title>Test Filing</title></head>"
            "<body>公告正文 000001.SZ</body></html>"
        )
...
class TestDownloader:
    ...
    def test_download_success(self, tmp_path):
        ...
        registry.register(
            SourceDescriptor(
                name="mock", source_type="exchange", default_level=SourceLevel.L1
            ),
    ...
    def test_download_compliance_403(self, tmp_path):
        ...
        registry.register(
            SourceDescriptor(
                name="forbidden", source_type="web", default_level=SourceLevel.L4
            ),
    ...
    def test_download_failure(self, tmp_path):
        ...
        class FailConnector(BaseConnector):
            ...
            def fetch(self, url, **kwargs):
                ...
                Raises:
                    ConnectionError: Always, to simulate a network outage.
                """
        ...
        registry.register(
            SourceDescriptor(
                name="fail", source_type="web", default_level=SourceLevel.L4
            ),
    ...
    def test_download_rejects_non_success_status_without_snapshot(self, tmp_path):
        ...
        registry.register(
            SourceDescriptor(
                name="missing", source_type="web", default_level=SourceLevel.L4
            ),
...
class TestSecurityMapper:
    ...
    def test_map_multiple(self):
        ...
        symbols = SecurityMapper.map_symbols(
            "000001.SZ 和 600000.SH 的联合公告"
        )
        assert "000001.SZ" in symbols
        assert "600000.SH" in symbols
