...
export const TEXT = {
  zh: {
    ...
    scheduleTaskDesc: "到点后由 MainAgent 启动 ML 量化与财报催化两条研究分支，完成反证与仓位融合后发布。",
    scheduleNext: "下次运行",
    scheduleLast: "上次触发",
  ...
  en: {
    ...
    scheduleTaskDesc: "At the scheduled time, MainAgent starts independent ML-quant and earnings-catalyst branches, then publishes after challenge review and portfolio fusion.",
