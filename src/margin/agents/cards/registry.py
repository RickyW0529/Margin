                    ...
                    tool_contracts=(
                        {
                            ...
                            "purpose": "Read a compact, frontend-safe candidate table.",
                            "input": {
                                "scope_version_id": "current research scope",
                                "universe": "candidate universe code",
                                "limit": "maximum rows",
                            },
                            "output": {"rows": "safe dashboard candidate rows"},
                        },
                    ),
                    deterministic=False,
                ),
