...
The `02-holdings` module is the portfolio management core of the current Margin implementation. It is responsible for recording trades, calculating position cost basis, importing transactions from manual entry or files, persisting portfolio data, tracking investment theses, and aggregating portfolio-level risk metrics.
