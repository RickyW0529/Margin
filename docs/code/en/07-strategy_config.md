...
The `07-strategy_config` module defines how investment strategies are created, validated, versioned, and promoted in the current Margin implementation. It is the single source of truth for the user-editable configuration that drives AI research, evidence requirements, decision boundaries, valuation assumptions, and risk limits.
