# Margin v0.1 Code Documentation Index (English)

This directory contains complete function-level documentation for Margin v0.1, organized by functional module. It covers backend Python modules, FastAPI endpoints, Next.js pages, React components, and deployment/observability configuration.
...
- **Map to specs/plans**: each module maps to `docs/spec/v0.1/<NN-module>/spec.md` and `docs/plan/v0.1/<NN-module>/`.

## Version Note

- This documentation set corresponds to Margin **v0.1**.
- Future versions will be placed under `docs/code/<version>/en/` without overwriting the current version.
