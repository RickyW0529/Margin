...
`05-rag_evidence` 是 Margin v0.1 的 RAG 证据子系统，负责把检索到的原始文本块 (Chunk) 转换为可审计、可定位、可验证的证据记录 (Evidence)，并在此基础上生成结构化 Claim，完成冲突检测、引用校验与持久化。
...
- spec 05 §3 / §4 / §7
- architecture §4.5、§5.3、§6.1、§6.2.1、§10.1、§10.2、§10.3、§25
- plan 0501 / 0502 / 0503
