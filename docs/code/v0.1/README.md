# Margin v0.1 功能代码说明索引

本目录按功能模块组织 Margin v0.1 的完整函数级代码说明，覆盖后端 Python 模块、FastAPI 接口、前端 Next.js 页面与 React 组件，以及部署与可观测性配置。
...
- **与 spec/plan 对照**：各模块文档对应 `docs/spec/v0.1/<NN-module>/spec.md` 与 `docs/plan/v0.1/<NN-module>/` 下的子任务计划。

## 版本说明

- 本文档集对应 Margin **v0.1**。
- 后续版本将在 `docs/code/<version>/` 下新建目录，不覆盖当前版本。
